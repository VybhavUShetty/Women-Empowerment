...
.pill-nav a {
  ...
  color: black;
  text-align: center;
  padding: 100px 188px 100px 188px;
  text-decoration: none;
  font-size: 17px;
  border-radius: 5px;
}
...
<div class="pill-nav">  
    ...
    <a href="STEP_Page">STEP</a>
    <a class="active" href="Contact_Page">NGOs</a>
